...
<p style="color: #bbb; font-size: 0.8rem; text-align: right; margin-top: -1rem;">My Erdős number is finite, but only just. <br> Computing it is an exercise left to the reader.</p>
